	...
	$.alerts = {
		...
		_show : function(title, msg, value, width, height, type, callback) {
			...
			$("BODY")
					.append(
							'<div id="popup_container" class="gSys_msg_box">'
									+ '<div id="popup_title" class="ptitle"><span class="fn-bg rc-l"></span><h4 id="popup_title_h4" style="width:60px;"></h4><span class="fn-bg rc-r"></span><a href="javascript:;" class="fn-bg aclose" title="关闭">关闭</a></div>'
			...
			case 'iframe':
				...
				$("#popup_container")
						.append(
								"<div id='popup_iframe_box' class='piframe'><div id='loading' class='loading'><img src='../common/thirdParty/jquery.alert.v1.2/loading.gif'></div></div>");
				$("#loading").css({
					width : width + "px",
					height : height + "px",
					padding : 0,
